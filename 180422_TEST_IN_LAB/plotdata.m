...
scope_8 = csvread('csv_files/scope_8.csv',2,0);
scope_9 = csvread('csv_files/scope_9.csv',2,0);
scope_13 = csvread('csv_files/scope_13.csv',2,0);
scope_14 = load('csv_files/scope_14.csv');
scope_17 = csvread('csv_files/scope_17.csv',2,0);
scope_18 = csvread('csv_files/scope_18.csv',2,0);
scope_21 = csvread('csv_files/scope_21.csv',2,0);
scope_22 = csvread('csv_files/scope_22.csv',2,0);
scope_24 = csvread('csv_files/scope_24.csv',2,0);
...
ylabel('Volt (mV)')
grid
print(fig,'radio_on_mote_reset_button_pushed','-dpng')
...
ylabel('Volt (mV)')
grid
print(fig,'run_time_algorithm_26_seconds','-dpng')